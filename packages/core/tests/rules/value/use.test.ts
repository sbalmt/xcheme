import { Context, TextSource, UseValuePattern, ExpectUnitPattern } from '../../../src/index';

/**
 * It change the current output value and can consume a sequence of characters 'a', 'b' and 'c'.
 */
const pattern = new UseValuePattern(0xabc, new ExpectUnitPattern('a', 'b', 'c'));
