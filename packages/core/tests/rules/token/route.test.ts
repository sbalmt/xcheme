import { Context, TextSource, MapFlowPattern, EmitTokenRoute, ExpectUnitPattern } from '../../../src/index';

/**
 * Routes map.
 */
const pattern = new MapFlowPattern(new EmitTokenRoute(0x1aa, 'a'), new EmitTokenRoute(0x2bb, new ExpectUnitPattern('c'), 'b'));
