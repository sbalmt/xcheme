import { Context, NodeDirection, TextSource, EmitNodePattern, ExpectUnitPattern } from '../../../src/index';

/**
 * It can consume a sequence of characters 'a', 'b' and 'c' and emits a new node into the main AST.
 */
const pattern = new EmitNodePattern(0xabc, NodeDirection.Left, new ExpectUnitPattern('a', 'b', 'c'));
