...
// Group
new Core.ScopeNodePattern(1 /* Right */, new Core.ExpectFlowPattern(new Core.ExpectUnitPattern(125 /* OpenParentheses */), new Core.RunFlowPattern(() => expression), new Core.ExpectUnitPattern(126 /* CloseParentheses */))), 
// Reference
...
const tokenStatement = new Core.ExpectFlowPattern(new Core.EmitSymbolPattern(300 /* Token */, new Core.AppendNodePattern(200 /* Identifier */, 1 /* Right */, 1 /* Right */, new Core.ExpectUnitPattern(100 /* Identifier */))), new Core.ExpectUnitPattern(123 /* As */), new Core.ScopeNodePattern(1 /* Right */, expression));
const nodeStatement = new Core.ExpectFlowPattern(new Core.EmitSymbolPattern(301 /* Node */, new Core.AppendNodePattern(200 /* Identifier */, 1 /* Right */, 1 /* Right */, new Core.ExpectUnitPattern(100 /* Identifier */))), new Core.ExpectUnitPattern(123 /* As */), new Core.ScopeNodePattern(1 /* Right */, expression));
