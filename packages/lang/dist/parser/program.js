...
// Range
new Core.PlaceNodePattern(1 /* Right */, new Core.ExpectUnitPattern(104 /* From */), new Core.AppendNodePattern(Core.BaseSource.Output, 1 /* Right */, 1 /* Right */, new Core.SetValuePattern(235 /* Alphabet */, new Core.ExpectUnitPattern(102 /* Alphabet */))), new Core.PivotNodePattern(234 /* Range */, 1 /* Right */, 0 /* Left */, new Core.SetValuePattern(234 /* Range */, new Core.ExpectUnitPattern(105 /* To */)), new Core.AppendNodePattern(Core.BaseSource.Output, 1 /* Right */, 1 /* Right */, new Core.SetValuePattern(235 /* Alphabet */, new Core.ExpectUnitPattern(102 /* Alphabet */))))), 
