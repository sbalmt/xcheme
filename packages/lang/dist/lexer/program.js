...
new Core.MapFlowPattern(new Core.SetValueRoute(102 /* Any */, 'a', 'n', 'y'), new Core.SetValueRoute(103 /* From */, 'f', 'r', 'o', 'm'), new Core.SetValueRoute(104 /* To */, 't', 'o'), new Core.SetValueRoute(105 /* Not */, 'n', 'o', 't'), new Core.SetValueRoute(106 /* Opt */, 'o', 'p', 't'), new Core.SetValueRoute(107 /* Rep */, 'r', 'e', 'p'), new Core.SetValueRoute(108 /* Place */, 'p', 'l', 'a', 'c', 'e'), new Core.SetValueRoute(109 /* Pivot */, 'p', 'i', 'v', 'o', 't'), new Core.SetValueRoute(110 /* Append */, 'a', 'p', 'p', 'e', 'n', 'd'), new Core.SetValueRoute(111 /* Prepend */, 'p', 'r', 'e', 'p', 'e', 'n', 'd'), new Core.SetValueRoute(112 /* Next */, 'n', 'e', 'x', 't'), new Core.SetValueRoute(113 /* Left */, 'l', 'e', 'f', 't'), new Core.SetValueRoute(114 /* Right */, 'r', 'i', 'g', 'h', 't'), new Core.SetValueRoute(115 /* Symbol */, 's', 'y', 'm', 'b', 'o', 'l'), new Core.SetValueRoute(116 /* Scope */, 's', 'c', 'o', 'p', 'e'), new Core.SetValueRoute(118 /* Or */, 'o', 'r'), new Core.SetValueRoute(117 /* And */, 'a', 'n', 'd'), new Core.SetValueRoute(119 /* Then */, 't', 'h', 'e', 'n'), new Core.SetValueRoute(120 /* Else */, 'e', 'l', 's', 'e'), new Core.SetValueRoute(121 /* Skip */, 's', 'k', 'i', 'p'), new Core.SetValueRoute(122 /* Alias */, 'a', 'l', 'i', 'a', 's'), new Core.SetValueRoute(123 /* Token */, 't', 'o', 'k', 'e', 'n'), new Core.SetValueRoute(124 /* Node */, 'n', 'o', 'd', 'e'), new Core.SetValueRoute(125 /* As */, 'a', 's'), new Core.SetValueRoute(102 /* Any */, '*'), new Core.SetValueRoute(118 /* Or */, '|'), new Core.SetValueRoute(117 /* And */, '&'), new Core.SetValueRoute(126 /* Semicolon */, ';'), new Core.SetValueRoute(127 /* OpenParentheses */, '('), new Core.SetValueRoute(128 /* CloseParentheses */, ')')), 
// String
