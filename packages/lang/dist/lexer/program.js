...
new Core.MapFlowPattern(new Core.SetValueRoute(103 /* Any */, 'a', 'n', 'y'), new Core.SetValueRoute(104 /* From */, 'f', 'r', 'o', 'm'), new Core.SetValueRoute(105 /* To */, 't', 'o'), new Core.SetValueRoute(106 /* Not */, 'n', 'o', 't'), new Core.SetValueRoute(107 /* Opt */, 'o', 'p', 't'), new Core.SetValueRoute(108 /* Rep */, 'r', 'e', 'p'), new Core.SetValueRoute(109 /* Place */, 'p', 'l', 'a', 'c', 'e'), new Core.SetValueRoute(110 /* Pivot */, 'p', 'i', 'v', 'o', 't'), new Core.SetValueRoute(111 /* Append */, 'a', 'p', 'p', 'e', 'n', 'd'), new Core.SetValueRoute(112 /* Prepend */, 'p', 'r', 'e', 'p', 'e', 'n', 'd'), new Core.SetValueRoute(113 /* Next */, 'n', 'e', 'x', 't'), new Core.SetValueRoute(114 /* Left */, 'l', 'e', 'f', 't'), new Core.SetValueRoute(115 /* Right */, 'r', 'i', 'g', 'h', 't'), new Core.SetValueRoute(116 /* Symbol */, 's', 'y', 'm', 'b', 'o', 'l'), new Core.SetValueRoute(117 /* Scope */, 's', 'c', 'o', 'p', 'e'), new Core.SetValueRoute(119 /* Or */, 'o', 'r'), new Core.SetValueRoute(118 /* And */, 'a', 'n', 'd'), new Core.SetValueRoute(120 /* Then */, 't', 'h', 'e', 'n'), new Core.SetValueRoute(121 /* Else */, 'e', 'l', 's', 'e'), new Core.SetValueRoute(122 /* Skip */, 's', 'k', 'i', 'p'), new Core.SetValueRoute(123 /* Alias */, 'a', 'l', 'i', 'a', 's'), new Core.SetValueRoute(124 /* Token */, 't', 'o', 'k', 'e', 'n'), new Core.SetValueRoute(125 /* Node */, 'n', 'o', 'd', 'e'), new Core.SetValueRoute(126 /* As */, 'a', 's'), new Core.SetValueRoute(103 /* Any */, '*'), new Core.SetValueRoute(119 /* Or */, '|'), new Core.SetValueRoute(118 /* And */, '&'), new Core.SetValueRoute(127 /* Semicolon */, ';'), new Core.SetValueRoute(128 /* OpenParentheses */, '('), new Core.SetValueRoute(129 /* CloseParentheses */, ')'), new Core.SetValueRoute(130 /* OpenChevron */, '<'), new Core.SetValueRoute(131 /* CloseChevron */, '>')), 
// Number
new Core.SetValuePattern(101 /* Number */, new Core.RangeUnitPattern('1', '9'), new Core.OptionFlowPattern(new Core.RepeatFlowPattern(new Core.RangeUnitPattern('0', '9')))), 
// String
