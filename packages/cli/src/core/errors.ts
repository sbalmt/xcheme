...
const errorMessages = {
  ...
  [Lang.Errors.UNDEFINED_AUTO_IDENTITY]: "Undefined <auto> identity, '{0}' at line {1}, column {2}.",
  ...
  [Lang.Errors.UNRESOLVED_NODE_REFERENCE]: "Node reference is not resolved yet, '{0}' at line {1}, column {2}.",
  [Lang.Errors.UNRESOLVED_ALIAS_TOKEN_REFERENCE]: "Alias Token reference is not resolved yet, '{0}' at line {1}, column {2}.",
  [Lang.Errors.UNRESOLVED_ALIAS_NODE_REFERENCE]: "Alias Node reference is not resolved yet, '{0}' at line {1}, column {2}.",
